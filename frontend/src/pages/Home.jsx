          ...
          <div className="topbar-second">
            ...
            <div className = "title-home">
             ...
             <h1>L'accès à la technologie<br/>
                  pour tous<br/>
                  <span className ="hightlight">un smarthphone</span><br/>
                    à la fois </h1>
                    </div>
                    <div className="title-paragraphe">
               <p className="para-title">Ensemble nous déterminer à faire une différence dans la vie <br/>
               des personnes exclues en leur offrant des opportunités et des outils nécessaires <br/>
                pour s'épanouir dans le monde de demain </p>
                </div>
